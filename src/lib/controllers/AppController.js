...
export class AppController {
  ...
  handleD() {
    if (this.isDev()) {
      ...
      // If we are in the grid (Aperçu on or off), jump to full dev mode with panel
   ...
   * Develop, or dropping the Aperçu filter).
  ...
  /**
   * S flips the Aperçu filter. From Develop it always lands in the grid
   * WITH Aperçu on — same "S jumps to storytelling" muscle memory as the old
